    ...
    <div class="table-responsive">
        <div style="margin-bottom: -10px;">
            <div style="float: left;width: 30%">
                <a href="usuarios/create" style="font-size: 28px;" data-toggle="tooltip" data-placement="right" title=""
                ...
                <tbody id="_results">
                    @foreach ($users as $user)
                        <tr class="even pointer">
                            ...
                            <td class=" last">
                                <a href="usuarios/{{ $user->id }}/edit" style="font-size: 15px;"><i
                                        class="fa fa-pencil"></i></a>
                                <a href="usuarios/{{ $user->id }}/finger-list"
                                    style="font-size: 15px;margin-left: 7px;color:#03579f;"><i
                                        class="fa fa-hand-o-up"></i></a>
                                <a href="javascript:void(0)" class="eliminar"
                                    data-titulo="¿Esta seguro de eliminar este registro?" data-id="{{ $user->id }}"
